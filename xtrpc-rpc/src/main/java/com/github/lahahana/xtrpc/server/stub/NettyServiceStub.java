...
public class NettyServiceStub extends AbstractServiceStub {
    ...
    public void bootstrap() throws StubInitializeException {
        bossEventGroup = new NioEventLoopGroup(1, new CustomThreadFactory("xtBossNettyIOThread"));
        workerEventGroup = new NioEventLoopGroup(Runtime.getRuntime().availableProcessors() * 2 + 1, new CustomThreadFactory("xtWorkerNettyIOThread"));
                ...
                .childHandler(new ChannelInitializer<Channel>() {
                    ...
                    protected void initChannel(Channel ch) throws Exception {
                        ch.pipeline().addLast(new RequestDecoder())
                                .addLast(new XTRequestInboundHandler())
